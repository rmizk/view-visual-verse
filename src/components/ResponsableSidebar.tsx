...
export const ResponsableSidebar: React.FC<ResponsableSidebarProps> = ({ isCollapsed = false }) => {
          ...
          <ContextMenuTrigger asChild>
            ...
            >
              <div className="flex items-center">
                <img
                  src="https://images.unsplash.com/photo-1494790108755-2616b612b691?w=32&h=32&fit=crop&crop=face"
                  alt={user?.name || 'Responsable'}
